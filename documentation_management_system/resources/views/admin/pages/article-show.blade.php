...
.editor-profile {
    ...
    object-fit: cover;        /* Crop image correctly */
...
<div class="container">
  ...
  <div class="title-bar">
    ...
    <a href="{{ route('admin.article.download', $article->id) }}" class="download-icon-button" title="Download">
    ...
    <div class="report-container">
      <img src="/images/book.jpg" alt="Wetlands at sunset" class="main-image">
    </div>
...
<div style="display: flex; align-items: center; gap: 16px; margin-top: 24px;">
    ...
    <div class="editor-info">
        <strong>{{ $article->editor->first_name ?? 'Unknown' }} {{ $article->editor->last_name ?? '' }}</strong><br>
        <span>Editor</span>
    </div>
</div>
