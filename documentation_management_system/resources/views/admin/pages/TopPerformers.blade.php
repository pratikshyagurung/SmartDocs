    ...
    <div class="top-performer-container">
        <div class="performer-card">
            ...
            <div class="performance-metric">
                <span class="metric-value">{{ $topPerformer->engagement_rate }}%</span>
            ...
            <div class="stats-grid">
                ...
                <div class="stat-item">
                    <div class="stat-value">{{ number_format($topPerformer->likes_count) }}</div>
    ...
    <div class="performance-listing">
        ...
        <div class="table-container">
            <table class="performance-table">
                ...
                <tbody>
                    @forelse($articlesByViews as $index => $article)
                    <tr>
                        <td><span class="rank-cell rank-{{ $index+1 }}">{{ $index+1 }}</span></td>
                        <td>
                            <div class="user-info">
                        ...
                        <td>
                            <div class="progress-bar">
                                <div class="progress-fill" style="width: {{ $article->engagement_rate }}%; background-color: #2563eb;"></div>
                                <span>{{ $article->engagement_rate }}%</span>
                            </div>
                        </td>
