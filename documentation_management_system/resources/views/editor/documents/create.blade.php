...
<body class="bg-gray-100 p-6">
  <div class="max-w-4xl mx-auto bg-white shadow p-6 rounded">
    ...
    <form action="{{ route('editor.documents.store') }}" method="POST">
      @csrf
...
<div class="mb-4">
    ...
    <select name="type" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2">
