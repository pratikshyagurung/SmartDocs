...
<body class="bg-gray-100 p-6">
  <div class="max-w-4xl mx-auto bg-white shadow p-6 rounded">
    <h2 class="text-2xl font-bold mb-4 text-gray-800">Edit Report</h2>
    ...
    <form action="{{ route('editor.reports.update', $report->id) }}" method="POST">
      @csrf
      @method('PUT')
      ...
      <div class="mb-4">
        ...
        >
          ...
          <option value="finalized" {{ old('status', $report->status) == 'finalized' ? 'selected' : '' }}>Finalized</option>
        </select>
      </div>
